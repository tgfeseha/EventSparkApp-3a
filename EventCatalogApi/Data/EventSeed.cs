    ...
    public static class EventSeed
    {
        ...
        private static IEnumerable<EventItem> GetPreConfiguredEventItems()
        {
            return new List<EventItem>()
            {
                ...
                new EventItem() { EventTypeId=7,EventLocationId=4,EventDateId=9, Description = " ", Name = "Arts and Crafts", EventStartTime= "1PM", EventEndTime= "5PM", Fee = 15, PictureURL = "http://externalcatalogbaseurltobereplaced/api/pic/7"  },
                ...
                new EventItem() { EventTypeId=13,EventLocationId=4,EventDateId=8, Description = " ", Name = "Fashion - Catwalk or Thrifting ",EventStartTime= "6PM", EventEndTime= "8PM",  Fee = 25, PictureURL = "http://externalcatalogbaseurltobereplaced/api/pic/13" },
